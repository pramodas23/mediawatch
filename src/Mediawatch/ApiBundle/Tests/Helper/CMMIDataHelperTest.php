...
namespace Mediawatch\ApiBundle\Tests\Helper;

use Mediawatch\ApiBundle\Helper\CMMIDataHelper;
...
class CMMIDataHelperTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testBuildArray()
    {
        ...
        $this->assertSame('http://www.mediawatch.me/api/speakers', $resultArray['_links']['self']['href']);
