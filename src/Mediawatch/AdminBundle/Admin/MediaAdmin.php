...
class MediaAdmin extends Admin
{
    ...
    public function getTemplate($name)
    {
        switch ($name) {
            case 'preview':
                return 'MediawatchMediaBundle:Media:preview.html.twig';
                break;
            default:
    ...
    protected function configureSideMenu(MenuItemInterface $menu, $action, AdminInterface $childAdmin = null)
    {
        ...
        $menu->addChild(
            'Speakers',
            array('uri' => $admin->generateUrl('mediawatch.common.admin.mediaspeaker.list', array('id' => $id)))
        );

        $menu->addChild(
            'Categories',
            array('uri' => $admin->generateUrl('mediawatch.common.admin.medialanguagecategory.list', array('id' => $id)))
        );

       $menu->addChild(
            'Tags',
            array('uri' => $admin->generateUrl('mediawatch.common.admin.mediatag.list', array('id' => $id)))
        );
    }
}
