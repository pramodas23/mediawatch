...
/**
 * Mediawatch\MediaBundle\Entity\Feedtype
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="Mediawatch\MediaBundle\Entity\FeedtypeRepository")
 */
class Feedtype
{
    /**
     ...
     * Add feeds
     *
     * @param Mediawatch\MediaBundle\Entity\Feed $feeds
     */
    public function addMedia(\Mediawatch\MediaBundle\Entity\Feed $feeds)
    {
        $this->feeds[] = $feeds;
    }
