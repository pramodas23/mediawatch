...
use Mediawatch\MediaBundle\Entity\Rating;
...
class MediaController extends Controller
{
    ...
    {
        $media = $this->getDoctrine()->getRepository('MediawatchMediaBundle:Media')->findOneBy(array('slug' => $slug));
        ...
        return $this->render('MediawatchMediaBundle:Speaker:show.html.twig', array('speakers' => $speakers));
    }
    ...
    public function rateAction($id, $rating)
    {
        if ($this->getRequest()->isXmlHttpRequest()) {
            $media = $this->getDoctrine()->getRepository('MediawatchMediaBundle:Media')->findOneById($id);
            ...
            $newAverage = $this->getDoctrine()->getRepository('MediawatchMediaBundle:Media')->getAverageRating($id);
            ...
            return $this->forward('MediawatchMediaBundle:Rating:index', array('rating' => $media->getRating()));
        }
    }
}
