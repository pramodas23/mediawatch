...
/**
 * Mediawatch\MediaBundle\Entity\Category
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="Mediawatch\MediaBundle\Entity\CategoryRepository")
...
class Category implements SluggableInterface
{
     ...
     * Add children
     *
     * @param \Mediawatch\MediaBundle\Entity\Category $children
     *
     * @return void
     */
