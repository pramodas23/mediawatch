...
/**
 * Mediawatch\MediaBundle\Entity\Tag
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="Mediawatch\MediaBundle\Entity\TagRepository")
...
class Tag implements SluggableInterface
{
     ...
     * Add media
     *
     * @param Mediawatch\MediaBundle\Entity\MediaTag $medias
     */
    public function addMedia(\Mediawatch\MediaBundle\Entity\MediaTag $media)
    {
        $this->medias[] = $media;
        $media->setTag($this);
