/*
*		@class MediaTest.SpeakerPanel
*		@extends Y.Base
*		@version 0.0.1
*
*/

YUI.add("mediawatch-panel", function(Y) {
    Y.log('mediawatch-panel is loaded', "info");
    ...
    var Clazz = Y.namespace("MediaTest").Panel = Y.Base.create("mediawatch-panel", Y.Base, [], {
        ...
        initializer: function (config) {
            ...
            this._getData = new Y.MediaTest.IO(this._getConfigure);
        ...
        _addSaveButton : function () {
            ...
            var saveButton = {
                ...
                action: Y.bind(function(e) {
                    ...
                    this._postData = new Y.MediaTest.IO(this._postConfigure);
