...
/**
 * Mediawatch\MediaBundle\Entity\Mediatype
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="Mediawatch\MediaBundle\Entity\MediatypeRepository")
 */
class Mediatype
{
    /**
     ...
     * Add medias
     *
     * @param Mediawatch\MediaBundle\Entity\Media $medias
     */
    public function addMedia(\Mediawatch\MediaBundle\Entity\Media $medias)
    {
        $this->medias[] = $medias;
    }
