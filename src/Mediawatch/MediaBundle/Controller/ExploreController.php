...
use Mediawatch\MediaBundle\Helpers\ExploreSortOptions;

use Symfony\Bundle\FrameworkBundle\Controller\Controller;
use Sensio\Bundle\FrameworkExtraBundle\Configuration\Route;
use Sensio\Bundle\FrameworkExtraBundle\Configuration\Template;
use Mediawatch\MediaBundle\Helpers\Paginator;
...
class ExploreController extends Controller
{
     ...
     * @Template("MediawatchMediaBundle:Explore:result.html.twig")
     */
    public function tagAction($search, $sort, $order)
    {
        ...
        return $this->render(
            'MediawatchMediaBundle:Explore:result.html.twig',
